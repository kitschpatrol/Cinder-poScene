...
void ShapeTextureSample::createFitIndicators() {
	...
	mFitIndicatorNames = {"NONE", "EXACT", "WIDTH", "HEIGHT", "INSIDE"};
...
void ShapeTextureSample::createAlignmentIndicators() {
	...
	mAlignIndicatorNames = {"O: NONE", "Q: TOP_LEFT", "A: CENTER_LEFT", "Z: BOTTOM_LEFT", "W: TOP_CENTER", "S: CENTER_CENTER", "X: BOTTOM_CENTER", "E: TOP_RIGHT", "D: CENTER_RIGHT", "C: BOTTOM_RIGHT"};
